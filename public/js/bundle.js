...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoidmliaGkiLCJhIjoiY2txejNhc3IxMWU1NDJ3bzYzN2cwZmtvZCJ9.3FISYWQMKtDqrEVj4iOoVQ';
  var map = new mapboxgl.Map({
    container: 'map',
    style: 'mapbox://styles/vibhi/ckqz6eusa5hc118qv1lhmof6i',
    scrollZoom: false // center: [-118.113491, 32.111745],
    // zoom: 4,
    // interactive: false,
...
},{"./../utils":"../../node_modules/axios/lib/utils.js","./../core/settle":"../../node_modules/axios/lib/core/settle.js","./../helpers/cookies":"../../node_modules/axios/lib/helpers/cookies.js","./../helpers/buildURL":"../../node_modules/axios/lib/helpers/buildURL.js","../core/buildFullPath":"../../node_modules/axios/lib/core/buildFullPath.js","./../helpers/parseHeaders":"../../node_modules/axios/lib/helpers/parseHeaders.js","./../helpers/isURLSameOrigin":"../../node_modules/axios/lib/helpers/isURLSameOrigin.js","../core/createError":"../../node_modules/axios/lib/core/createError.js"}],"../../../../../../.nvm/versions/node/v16.3.0/lib/node_modules/parcel-bundler/node_modules/process/browser.js":[function(require,module,exports) {
...
},{"./utils":"../../node_modules/axios/lib/utils.js","./helpers/normalizeHeaderName":"../../node_modules/axios/lib/helpers/normalizeHeaderName.js","./adapters/xhr":"../../node_modules/axios/lib/adapters/xhr.js","./adapters/http":"../../node_modules/axios/lib/adapters/xhr.js","process":"../../../../../../.nvm/versions/node/v16.3.0/lib/node_modules/parcel-bundler/node_modules/process/browser.js"}],"../../node_modules/axios/lib/core/dispatchRequest.js":[function(require,module,exports) {
'use strict';
...
},{"axios":"../../node_modules/axios/index.js","regenerator-runtime":"../../node_modules/regenerator-runtime/runtime.js","./alert":"alert.js"}],"updateSettings.js":[function(require,module,exports) {
"use strict";
        ...
        switch (_context.prev = _context.next) {
          ...
          case 4:
            ...
            if (result.data.status === 'success') {
              (0, _alert.showAlert)('success', "".concat(type[0].toUpperCase() + type.substring(1), " updated"));
...
},{"axios":"../../node_modules/axios/index.js","regenerator-runtime":"../../node_modules/regenerator-runtime/runtime.js","./alert":"alert.js"}],"stripe.js":[function(require,module,exports) {
"use strict";
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            stripe = Stripe('pk_test_51JEdzsSJ7TjrX4UfeUrlWDw6lLucKnDEDGQfx1YOcpV3TJCzd8TDZvXabOkxx0HmA43qdrFIjoV7pcczs3hFqZx600DqAYvRy5'); // 1) Get the session from the server
...
var bookBtn = document.getElementById('book-tour'); //  Map to be shown over tour page (load only on tour page)
...
if (logOutBtn) logOutBtn.addEventListener('click', _login.logout); // Update user data such as name and email
...
if (bookBtn) {
  bookBtn.addEventListener('click', function (e) {
    e.target.textContent = 'Processing'; // alternate way  const tourId  = e.target.dataset.tourId;

    var tourId = e.target.dataset.tourId;
    (0, _stripe.bookTour)(tourId);
  });
}
},{"core-js/stable":"../../node_modules/core-js/stable/index.js","regenerator-runtime/runtime":"../../node_modules/regenerator-runtime/runtime.js","./mapbox":"mapbox.js","./login":"login.js","./updateSettings":"updateSettings.js","./stripe":"stripe.js"}]},{},["index.js"], null)
